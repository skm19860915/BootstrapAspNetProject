<%@ Page Language="C#" CodeFile="index1.aspx.cs" Inherits="BoatRenting.indexN1_aspx_cs" EnableEventValidation="false" AutoEventWireup="true" EnableViewState="true" %>
...
<%--<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAatlpiVFUHTp58Ig2BHm9I-KeMDH3bXVQ&libraries=places" ></script>--%>
...
<%--       <script>
  ...
  <body class="body" style="position:static">
      <form id="frmIndex" runat="server" method="post">
              ...
              <div class="searchbar">
                <div class="text-center search-form">
                   <div  class="form-on-scroll">
                        <input type="text" placeholder="Where would you like go boating?" runat="server" id="txtSearch1" >
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        ...
                        <div class="parahgraph text-center">
                            <p>Find your dream boat rental in the best boating locations in the world.<br class="d-md-none d-lg-block">
                                Rent luxury yachts, sailboats, houseboats, pontoon boats, charter boats, jet skis and more.</p>
                        </div>
                    </div>
                </div>
                <div class="row pt-3 mt-3">
                    ...
                    <a href="results.aspx?t=4&lat=25.47303326127954&lng=-77.080078125&miles=140&c=6">
                        <div class="service-box clearfix p-3">
                            <div class="service-icon text-center"><img src="images/icon-1.svg"> </div>
                    ...
                    <div class="col-md-4 col-xl mt-3">
                       <a href="results.aspx?t=4&lat=25.684850188749582&lng=-79.984588623046885&miles=38">
                        <div class="service-box clearfix p-3">
                            <div class="service-icon text-center"><img src="images/icon-2.svg"> </div>
                            <div class="service-desc text-center">
                                <h4>MIAMI</h4>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4 col-xl mt-3">
                       <a href="results.aspx?t=4&lat=40.094882122321195&lng=-72.86407470703125&miles=75">
                        <div class="service-box clearfix p-3">
                            <div class="service-icon text-center"><img src="images/icon-3.svg"> </div>
                            <div class="service-desc text-center">
                                <h4>NEW YORK CITY</h4>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4 col-xl mt-3">
                       <a href="results.aspx?t=4&lat=22.749588557614043&lng= -121.21078491210938&miles=176">
                        <div class="service-box clearfix p-3">
                            <div class="service-icon text-center"><img src="images/icon-4.svg"> </div>
                            <div class="service-desc text-center">
                                <h4>DALLAS</h4>
                    ...
                    <div class="col-md-4 col-xl mt-3">
                        ...
                        <div class="service-box clearfix p-3">
                        <div class="service-icon text-center"><img src="images/icon-5.svg"> </div>
                            <div class="service-desc text-center">
                                <h4>LOS ANGELES</h4>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4 col-xl mt-3">
                       <a href="results.aspx?t=4&lat=22.749588557614043&lng=-121.21078491210938&miles=753">
                        <div class="service-box clearfix p-4">
                            <div class="service-icon text-center"><img src="images/icon-6.svg"> </div>
                            <div class="service-desc text-center">
                                <h4>SAN DIEGO</h4>
    ...
    <div class="container">
        ...
        <div class="row pt-3 mt-3">
            ...
            <div class="col-sm-6  col-lg-3 mb-3 mb-lg-0">
                <div class="card">
                    <img class="card-img-top" src="./boats/<%# DataBinder.Eval(Container.DataItem, "FileName") %>" alt="<%# DataBinder.Eval(Container.DataItem, "FilenameDescription") %>" height="220" width="255" />
                    <div class="card-body">
    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-md-5 text-center text-md-right align-self-center">
                <a href="#" class="btn btn-custom-lg">List Your Boat</a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6 owner-text-info">
                <div class="title title-head text-left mb-5 mb-lg-0 ml-0 ml-lg-4">
                    ...
                    <a href="#" class="btn btn-custom-lg">Learn More</a>
                </div>
            </div>
           ...
           <%-- form tag here--%>
            ...
            <form class="pb-5">
                <div class="form-group text-field">
                  <asp:TextBox type="text" runat="server" class="form-control" id="txtLoginName" placeholder=" " required />
                 
                    <label class="style-lable">Email</label>
                </div>
                <div class="form-group text-field">
                  <asp:TextBox type="password" runat="server" class="form-control" id="txtPassword" placeholder=" " required />
