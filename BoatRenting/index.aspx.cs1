...
namespace BoatRenting {
       ...
       IDataReader idr = cmd.ExecuteReader();
                  ...
                  while (idr.Read())
                  {
                      HomePagePhotos rec = new HomePagePhotos(getSafeString(idr, BNameIndex), getSafeString(idr, BodyOfWaterIndex), getSafeString(idr, StateNameIndex),
                           ...
                           getSafeDecimal(idr,AmountIndex), getSafeString(idr,FileNameIndex),getSafeString(idr,FilenameDescriptionIndex),getSafeInt(idr,BoatIdIndex),getSafeInt(idr,MarinaIdIndex),getSafeInt(idr,ratingIndex));
    ...
    public class HomePagePhotos
  {
      ...
      public HomePagePhotos(string boatname, string BodyOfWater, string state, string city, string year, string make, string model,
          string category, string boatSize, string amount, string filename, string filenameDescription, string boatId, string marinaId, string rating)
      {
