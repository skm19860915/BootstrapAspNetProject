<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MemberSignInR.aspx.cs" Inherits="MemberSignInR" %>
...
<!--==============================content=================================-->
      ...
      <div class="container" >
      	<div class="row_header2" align="center" >
        	<h1 class="white" >First please sign in or sign up. </h3>
...
<!--==============================content=================================-->
 ...
 <div class="container">
        <div class="card card-container">
         ...
         <a href="./ClientSignup.aspx?askq=1"  style="color:#248992!important;text-decoration:underline!important">Ask a question sign up</a> 
            ...
            <div class="form-signin">
                ...
                <asp:Button ID="btnLogin" runat="server" Text="Ask a question !" style="padding:0px!important;" CssClass="btn btn-lg btn-primary btn-block btn-signin" OnClick="btnLogin_Click" />
            </div><!-- /form -->
