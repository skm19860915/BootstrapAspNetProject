...
<html lang="en">
<head>
    <title>Boat Rentals near you / Affordable Alternative to Boat Ownership</title>
    <meta charset="utf-8">
    <meta http-equiv="Cache-control" content="public, max-age=600" />
     <link rel="icon" href="img/favicon.ico" type="image/x-icon">
    <link rel="shortcut icon" href="img/favicon.ico" type="image/x-icon" />
    <meta name="format-detection" content="telephone=1-888-610-2628" />
    <meta name="description" content="The authority in boat rentals. Find & book affordable boat rentals with or without a captain. Rent sailboats, jet skis, yachts charters and other watercrafts anywhere in the world. Rated #1 in customer satisfaction.">
  ...
  <style>
    ...
    background-color:rgb(0, 114, 160);
     ...
     <%--     <nav class="NavTop">--%>
         ...
         <%--   </nav>--%>
             <div id="stick-here" style="top:10px!important;"></div>
    ...
    sticktothetop();
                ...
                <style>
                    ...
                    .sicon
                    {
                          ...
                          background-image:url("find.png")!important;   
                    ...
                    <div align="center">
                        ...
                        <div  id="search">
                                <div id="stickThis">
                                    ...
                                    <asp:TextBox ID="txtSearch"  runat="server" placeholder="Where do you want to boat?"  onkeypress="clearAddressSelection()" onfocus="this.placeholder=''" onblur="this.placeholder='Where do you want to boat?'" CssClass="sicon"></asp:TextBox>
                    ...
                    <div style="position: relative; border: 1px solid #ddd; margin: 0; max-width: 320px; width: 100%; z-index: 5; margin-top: -22px; padding: 7px" align="center">
                        <div style="line-height: 18px; text-align: left">
                            ...
                            <ul>
                                ...
                                <li>5% renter side booking fee.</li>
                                <li>Free listing. No owner fees.</li>
                                <li>User-friendly owner dash board.</li>
                                <li>Booking request approved by owners. </li>
                            </ul>
                        </div>
