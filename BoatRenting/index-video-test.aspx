...
<html lang="en">
<head>
    <title>TRANSIENT BOAT SLIPS, BOAT SLIP RENTALS, DOCK RENTALS, BOAT DOCK RENTAL & VACANT BOAT SLIPS</title>
    <meta charset="utf-8">
    <meta http-equiv="Cache-control" content="public, max-age=600" />
     <link rel="icon" href="img/favicon.ico" type="image/x-icon">
    <link rel="shortcut icon" href="img/favicon.ico" type="image/x-icon" />
    <meta name="format-detection" content="telephone=1-888-610-2628" />
    <meta name="description" content="Find & book affordable transient boat slips. Rent vacant boat slips, dock space, boat slips anywhere in the world. Rated #1 in customer satisfaction.">
        ...
        * {
        ...
        .btn1 {
            ...
            .btn1 span {
                ...
                text-align: center;
                width: 100%;
                background-image: -webkit-linear-gradient(top,#f28452,#f37339);
                background-image: -moz-linear-gradient(top,#f28452,#f37339);
                background-image: -ms-linear-gradient(top,#f28452,#f37339);
                background-image: -o-linear-gradient(top,#f28452,#f37339);
                background-image: linear-gradient(to bottom,#f28452,#f37339);
                -webkit-border-radius: 14;
                -moz-border-radius: 14;
                border-radius: 14px;
                color: #fff;
                padding: 10px 20px 10px 20px;
                border: 3px #f37339 solid;
            }
        ...
        .btn3 {
            ...
            width: 100%;
            background: #f28452;
            background-image: -webkit-linear-gradient(top,#f28452,#dc3d58);
            background-image: -moz-linear-gradient(top,#f28452,#dc3d58);
            background-image: -ms-linear-gradient(top,#f28452,#dc3d58);
            background-image: -o-linear-gradient(top,#f28452,#dc3d58);
            background-image: linear-gradient(to bottom,#f28452,#dc3d58);
            -webkit-border-radius: 14;
            -moz-border-radius: 14;
            border-radius: 14px;
            color: #fff;
        ...
        .background-homesize {
            background: url(https://www.rentaboat.com/images/large-homepage3xxx.jpg) no-repeat top center;
...
<%--	<link href="css/bootstrap-theme.min.css" rel="stylesheet" type="text/css" />
  ...
  <script src="https://maps.googleapis.com/maps/api/js?v=3.exp&sensor=false&libraries=places&Key=AIzaSyDUasdm918z0Cm88TSAymH85w_MVYK95Nk" async></script>
...
<body>
    ...
    <form id="frmIndex" runat="server">
        ...
        <header id="" style="" class="background-homesize2">
            <!-- TOP LINE -->
...
<video autoplay loop id="video-background" muted plays-inline>
  <source src="transient-slip-video.mp4" type="video/mp4">
</video>
            ...
            <img src="img/transient-logo-sm.png" alt="Rent A Boat" style="margin-left:30px;"/>
                    </asp:HyperLink>
            ...
            <div class="container">
                <div class="row_header-home2" style="padding: 90px 0 50px 0;">
                    <div align="center" style="margin-top:300px;" >
                    <div style="background: rgba(255, 255, 255, 0.4); padding:20px; width:60%; ">
                        <h1 class="white" style="font-size: 50px; color:#f28452; text-shadow: 2px 2px #000000;">Transient Boat Slips</h1>
                        <div style="width: 65%; margin-left: auto; margin-right: auto">
                            <hr />
                        </div>

                        <h3 style="color: #fff; font-weight:bold;">Boat dockage for the traveling boater.</h3>

                        <div class="search" id="search">
                            <asp:TextBox ID="txtSearch" runat="server" placeholder="Where do you want to pull in?" Style="font-size: 16px;" onkeypress="clearAddressSelection()"></asp:TextBox>
  ...
  <div  style="background-color:#fff;">
        ...
        <div class="container" style="background-color:#fff;">
            ...
            <div class="row" style="padding: 0px 0px">
                ...
                <div class="row " align="center">
                    <div class="col-lg-12 col-sm-12 padbot20">
                        <h2 class="home-title"><strong>Popular transient boat slip locations</strong></h2>
                        <br>
                        ...
                        <div style="max-width: 900px; width: 100%;">
                            <p style="color: #318e98; font-size: 20px;">Find a vacant transient boat slip in the best boating locations in the world.</p>
                            <p style="color: #318e98; font-size: 19px;">Rent or list a transient slip for luxury yachts, sailboats, houseboats, pontoon boats, charter boats, jet skis and more.</p>
            ...
            <div class="row" style="padding: 50px 0px">
                <div align="center">
                    <h2 style="color: #f28452;"><strong>New Boat Slips On TransientSlips.com</strong></h2>
                    <br>
                </div>
        ...
        <div class="container">
                    ...
                    <div style="position: relative; border: 1px solid #ddd; margin: 0; max-width: 320px; width: 100%; z-index: 5; margin-top: -22px; padding: 7px" align="center">
                        <div style="line-height: 18px; text-align: left">
                            ...
                            <ul>
                                ...
                                <li>Reach millions of Boat Owners.</li>
                ...
                <div align="center" class="col-lg-4 col-sm-4 padbot20">
                    ...
                    <div style="position: relative; border: 1px solid #ddd; margin: 0; max-width: 320px; width: 100%; z-index: 5; margin-top: -22px; padding: 7px" align="center">
                        <div style="line-height: 18px; text-align: left;">
                            <br>
                            <ul>
                                <li>Lowest transient slip rates available.</li>
                                <li>Easy searching/Easy booking.</li>
                                <li>No membership fees.</li>
                                <li>No monthly dues.</li>
                                <li>Access vacant boat slips within seconds!</li>
                            </ul>
                        </div>
            ...
            <div align="center" class="row" style="padding: 10px;">
                ...
                <br>
                <br>
                <h2 style="color: #000000;">Earn money by listing your vacant boat slip today!</h2>
                <h1 style="color: #000000;">
                    <p>TransientSlips.com is an online boat slip service dedicated to connecting marinas or private owned boat slips with individuals looking to rent a transient slip.</p>

                    <p>TransientSlips.com is a sub-corporation of Hilderbrandt Industries. Our site's main operations are handled from our Marina, Beaver Dam Boat Basin in Brookhaven, New York. Beaver Dam Boat Basin is a company that specializes in boat rentals, jet ski rentals, boat services, storage, and slip leasing.</p>

                    <p>Not only do we own the number 1 domain name, TransietSlips.com, but we also own RentABoat.com and RentABoatCaptain.com. Why does this help your services? Having transient slips in our domain name impacts our website's success in nearly every area, including search engine optimizations (SEO), such as Google and social media marketing (SMM). Having websites such as RentABoat.com and RentABoatCaptain.com allows boat renters and boat captain's to see our website TransietSlips.com and book a slip while renting a boat with our other sites.
</p>
                ...
                <a href="./Admin/BoatOwnerSignup.aspx">
                    <div style="background-color: #fe595e; padding: 5px; max-width: 300px; width: 100%;" align="center">
                        <h2 style="color: #fff;">List your vacant slip!<br>
                            (Click here)</h2>
                    </div>
                </a>
            ...
            <div align="center" class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 ">
                        <h2>Transient Slips by state</h2>
                        <hr>
                    </div>
                    <div class="row">
