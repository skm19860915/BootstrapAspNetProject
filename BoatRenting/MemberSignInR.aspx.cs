...
public partial class MemberSignInR : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        //if (!Page.IsPostBack)
        {
           if (Request.QueryString["askq"] != null && Request.QueryString["askq"] == "1")
            ...
            {
                Response.Redirect("https://www.rentaboat.com/");
            }
        }
    ...
    protected void btnLogin_Click(object sender, EventArgs e)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            if (IsInactiveBoat(dt.Rows[0]["in_MarinaID"].ToString(), Session[Util.Session_Selected_BoatID].ToString()))
            {
