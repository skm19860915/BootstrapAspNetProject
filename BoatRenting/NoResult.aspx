<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NoResult.aspx.cs" Inherits="NoResult" %>
    ...
    <div class="container search-container py-4">
        <div class="row justify-content-center py-4">
            <div class="col-lg-12">
                <div class="title-head text-center">
                    <h2 class=" pt-5 pb-4">Search Results</h2>
                </div>
            </div>
        </div>
        <div class="row justify-content-center pt-3 pb-5">
            <div class="col-lg-10 py-2">
                <div class="title-head text-center">
                    <h3 class="text-capitalize">Oh no!</h3>
                    <p>Unfortunately, no direct results were found in your desired search area. Here are some boats we found outside and closest to your search." Please leave us your email so we can send you info on boats in your desired boating area when we they become available.</p>
                </div>
            </div>
            <div class="col-10 col-md-6 py-2">
                <div class="input-group mb-3">
                    <input type="text" class="form-control" placeholder="Your Email" aria-label="Your Email" aria-describedby="basic-addon2" runat="server" id="txtEmail">
                    <div class="input-group-append">
						<button type="submit" class="input-group-text" runat="server" id="btnSendEmail" onserverclick="btnSendEmail_Click">
