<%@ Page Language="C#" AutoEventWireup="true" CodeFile="how-it-works.aspx.cs" Inherits="how_it_works" %>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="title-head text-center">
                    <h2 class="pt-5 pb-4">HOW TO LIST A BOAT</h2>
                </div>
            </div>
        </div>
        <div class="row text-center text-md-left mt-5">
            <div class="col-md-6 mb-3 mb-md-0">
                <div class="how-it-works-img">
                    <a href="#"><img class="img-fluid" src="img/how-it-works-1.jpg" alt="image"></a>
                </div>
            </div>
            <div class="col-md-6 pl-md-0">
                <div class="how-it-works-info">
                    <h3 class="text-uppercase">LISTING A BOAT IS EASY</h3>
                    <p>At Rentaboat we believe both finding and listing a boat should be easy. Boat owners can easily list their boats and control all terms of the rental with our owner management system. Boat renters can easily search by location for the perfect boats in great locations and request boat rentals online in just a few clicks. List your boat (it’s free!)</p>
    ...
    <div class="container search-container">
        ...
        <div class="row text-center text-md-left">
            <div class="col-12">
                <div class="title-head text-center">
                    <h1 class="pt-5 pb-4">
                        SIMPLE STEPS TO RENT A BOAT
                    </h1>
                </div>
            </div>
            <div class="col-12">
                        <div class="how-it-works-img text-center">
                            <a href="#"><img style="max-width: 80%" class="img-fluid" src="img/how-it-works-2.jpg" alt="image"></a>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="d-sm-flex mb-3 ">
                            ...
                            <h5 class="align-self-center m-0">Create a listing</h5>
                        </div>
                        <p>Creating your boat listing will only take you a couple of minutes. Simply fill out your full name, email, and create a password. Once you press save, you will be able to edit your profile and add your boat information. After your listing is approved, your boat will go live on RentABoat.com for millions of potential boat renters to view.</p>
                    </div>
                    </div>
                    <div class="col-md-6">
                        <div class="how-it-works-step-box mb-3">
                        <div class="d-sm-flex mb-3 ">
                            ...
                            <h5 class="align-self-center m-0">Receive boat rental requests</h5>
                        </div>
                        <p>Boat owners will receive tentative rental requests via email or text message. This is when owners and renters will receive each other's contact information. The potential renter receives an email that explicitly explains this is only an online rental request, it is tentative and they must contact you to confirm availability, requirements, and approval.</p>
                    </div>
                    </div>
                    <div class="col-md-6">
                        <div class="how-it-works-step-box mb-3">
                        <div class="d-sm-flex mb-3 ">
                            ...
                            <h5 class="align-self-center m-0">Collect the money</h5>
                        </div>
                        <p>Owners are asked to collect their rental amount and deposits directly from their rental client. RentABoat’s online fee is strictly a transaction fee and is not a deposit. Boat owners are asked to deduct RentABoat's online transaction fee from the listed rental price. This fee is paid by the rental client. It is the only fee RentABoat will charge.</p>
                    </div>
                    </div>
                    <div class="col-md-6">
                        <div class="how-it-works-step-box mb-3">
                        <div class="d-sm-flex mb-3 ">
                            ...
                            <h5 class="align-self-center m-0">Share the water experience</h5>
                        </div>
                        <p>Meet your renter and provide them with that water boating experience that we all love. If it's a captained charter, connect them with a captain of your choice . Anyway you can provide that perfect boating water experience, we are here to help. Then lets get ready for the next RentABoat.com rental request.</p>
                    </div>
                    </div>
                    <div class="col-12">
                        <h3 class="text-uppercase mt-4 mb-2 text-center">WHY CHOOSE RENTABOAT</h3>
                    </div>
                    <div class="col-md-6">
                        <div class="how-it-works-step-box mb-3">
                        <div class="d-sm-flex mb-3 ">
                            ...
                            <h5 class="align-self-center m-0">Safe and easy</h5>
                        </div>
                        <p>We offer the right options for boat renters and boat owners. Both renters and owners can rate their experience allowing renters to find the perfect boat and boat owners to find qualified customers.</p>
                        <p>You can require renter-side insurance that can be purchased through any one of these two agencies <a style="color: blue; text-decoration: underline !important" href= https://www.xinsurance.com/risk-class/boat-insurance-personal-watercraft-insurance/" target="_blank>">ExInsurance Boat Rental Policy.</a> <a style="color: blue; text-decoration: underline !important" href= https://www.globalmarineinsurance.com/boat-rental-insurance/" target="_blank>">Global Marine Insurance Agency.</a></p>
                    </div>
                    </div>
                    <div class="col-md-6">
                        <div class="how-it-works-step-box mb-3">
                        <div class="d-sm-flex mb-3 ">
                            ...
                            <h5 class="align-self-center m-0">You're in control</h5>
                        </div>
                        <p>Boat Owners set the price, availability, requirements and decide who rents their boats. You have total control over your boat listing. At anytime you can edit, deactivate or pause your listing. Set up black out dates for those days you use the boat. Our owners management system allows boat owners to input their own clients, fee free.</p>
                    </div>
                    </div>
                    <div class="col-md-6">
                        <div class="how-it-works-step-box mb-3">
                        <div class="d-sm-flex mb-3 ">
                            ...
                            <h5 class="align-self-center m-0">Listing options</h5>
                        </div>
                        <p>RentABoat offers multiple different listing options for all types of boater owners. Private boat owners, Charter companies, Boat rental facilities, and Water recreational companies. For more information regarding RentABoat's payment options, please view our boat owners <a style="color: blue; text-decoration: underline !important" href= /owners-faqs.aspx>FAQ's here.</a></p>
                    </div>
                    </div>
                    <div class="col-md-6">
                        <div class="how-it-works-step-box mb-3">
                        <div class="d-sm-flex mb-3 ">
                            ...
                            <h5 class="align-self-center m-0">Try our Demo</h5>
                        </div>
                        <p>You can try all of our features by using our "DEMO" portal. Sign in using "Demo" as the username and "Demo" as the password. If you have a website, try our Display Ad listing, we can add a link that directs potential renters to your website. Sign in using "DemoAd" as the username and "DemoAd" as the password.</p>
                    </div>
                    </div>
                </div>
            </div>
