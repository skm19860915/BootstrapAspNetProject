            ...
            <div class="container">
                <div class="row_header-home2">
                    <div align="center">
                        ...
                        <div  id="search">
                                <div id="stickThis">
                            <asp:TextBox ID="txtSearch" runat="server" placeholder="Where do you want to boat?" Style="font-size: 16px;" onkeypress="clearAddressSelection()" CssClass="sicon"></asp:TextBox>
