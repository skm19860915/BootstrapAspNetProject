...
<!--==============================content=================================-->
      ...
      <div class="container" ><div class="row_header-home" >
           <div align="center">
            <h1 class="white" style="font-size:50px;">Boat Rentals & Charters</h1>
		   		<div style="width:65%; margin-left:auto; margin-right:auto"><hr /></div>
                
                <h3  style="color:#fff;">Search boat rentals worldwide</h3>
...
<br>
                <div style="max-width:900px; width:100%;" >
                    <p style="color:#fff; font-size:20px;">Find your dream boat rental in the best boating locations in the world.
</p>   <p style="color:#fff; font-size:19px;">Rent luxury yachts, sailboats, houseboats, pontoon boats, charter boats, jet skis and more. 
</p>
                </div>
...
<div class="container">      
    		...
    		<div style=" position:relative; background-color:#fff; width:100px; padding:5px; z-index:15;"><h3>Owners</h3></div>
 			<div style=" position:relative; border:1px solid #ddd; margin:0; max-width:320px;width:100%; z-index:5; margin-top:-22px; padding:7px" align="center">
    			<div style="line-height:18px; text-align:left"><br>
    				<ul>
    				<li> 15% broker fee paid by Renter.</li>
    ...
    <!--==============================row_2=================================-->
                    ...
                    <br><br>
    <h1 style="color:#000000;">Earn money by listing your boat today!</h1><br>
  ...
  <div class="full_width" style=" padding:15px 0;" >
        <div align="center"  class="container">
          <div class="row" >
                ...
                <h2>Boat rentals by state</h2><hr></div></div>
                 <div class="row">
...
<a href="results.aspx?t=3&s=DE">Delaware</div>
<div class="col-lg-2 col-md-2 " style="size:18px;">
...
<a href="results.aspx?t=3&s=KS">Kansas</div>
<div class="col-lg-2 col-md-2 " style="size:18px;">
...
<a href="results.aspx?t=3&s=MS">Mississippi</div>
 <div class="col-lg-2 col-md-2 " style="size:18px;">
...
<a href="results.aspx?t=3&s=ND">North Dakota</div>
<div class="col-lg-2 col-md-2 " style="size:18px;">
...
<a href="results.aspx?t=3&s=TN">Tennessee</div>
<div class="col-lg-2 col-md-2 " style="size:18px;">
...
<a href="results.aspx?t=3&s=WY">Wyoming</div>
